...
impl SimpleComponent for PlayerPage {
    ...
    view! {
            ...
            gtk::Box {
                ...
                // ================= 1. 播放来源 =================
                gtk::Label {
                    #[track = "model.changed(PlayerPage::source_name())"]
                    set_label: &model.source_name,
                ...
                gtk::Box {
                    set_orientation: Orientation::Vertical,
                    set_spacing: 4,
                    set_width_request: 280, // 限制进度条最大宽度
    ...
    fn update(&mut self, message: Self::Input, sender: ComponentSender<Self>) {
        ...
        match message {
            PlayerPageMsg::UpdateTrack {
                ...
                self.set_source_name(source);
                self.set_song_name(title);
                self.set_artist_album(format!("{} - {}", artist, album));
