...
use crate::api::{Album, ArtistDetail, Mv, Song, get_artist_album, get_artist_detail, get_artist_mv, get_artist_song};
use crate::ui::components::artist::album_grid::AlbumGridInput;
use crate::ui::components::artist::mv_grid::MvGridInput;
...
impl Component for ArtistPage {
    ...
    fn init(
        ...
        let songs = SongList::builder().launch(()).detach();
        let albums = AlbumGrid::builder().launch(()).detach();
        let mvs = MvGrid::builder().launch(()).detach();
        ...
        widgets.content_stack.add_titled(model.songs.widget(), Some("songs"), "热门单曲");
        widgets.content_stack.add_titled(model.albums.widget(), Some("albums"), "所有专辑");
        widgets.content_stack.add_titled(model.mvs.widget(), Some("mvs"), "相关MV");
        ...
        let bio_page = gtk::ScrolledWindow::builder()
            ...
            .child(&bio_label)
            .build();
        widgets.content_stack.add_titled(&bio_page, Some("bio"), "艺人简介");
